                ...
                <table class="basic_write">
                    ...
                    <colgroup>
					   ...
					   <tr>
                        ...
                        <td><input type="text" title="제목" name="bbsTitle" id="" class="add_txt"  placeholder="제목 *"></td>
                    </tr>
                    <tr>
                        <th>작성자<span class="star">*</span></th>
                        <td><input type="text" title="성명" name="bbsName" id="" class="name_txt" placeholder="성명 *"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                           <textarea name="bbsContent" id="" cols="30" rows="10" style="width:100%"></textarea>
                        </td>
                    </tr>
                
                </table>               
                <div class="btn_area">
					<button type="submit" class="btn_blue" style='cursor:pointer;'>확인</button>
